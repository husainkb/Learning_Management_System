...
# Project Description 📝
StudyLearner is a fully functional ed-tech platform that enables users to create, consume, and rate educational content. <br/>
...
| Section                 | Description                                  |
|-------------------------|----------------------------------------------|
| [StudyLearner Aim](#StudyLearner-aim-)        | 📚 Overview of StudyLearner's goals            |
...
## System Architecture 🏰
<br/>
☝ The StudyLearner ed-tech platform consists of three main components:  <br/>
...
#### The front end of StudyLeaner has all the necessary pages that an ed-tech platform should have. Some of these pages are: 
...
- **Cloud-based Media Management ☁️ :** StudyLearner uses Cloudinary, a cloud-based media management service, to store and manage all media content, including images, videos, and documents.
...
The back-end of StudyLearner uses several data models and database schemas to manage data, including:
